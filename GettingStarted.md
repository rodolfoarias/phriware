Getting started with pHRIWARE is easy. Simply download the latest zip file from [here](https://code.google.com/p/phriware/source/browse/#svn%2Ftags), then extract all of the files onto your MATLAB path.
